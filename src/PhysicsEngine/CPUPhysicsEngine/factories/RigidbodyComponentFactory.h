...
/**
 * RigidBody Component Factory - Creates and configures rigidbody components
 * 
 * This factory handles the creation of individual components that make up a rigidbody:
 * - TransformComponent: Position, rotation, scale
 * - PhysicsComponent: Velocity, mass, material properties
 * - BoxColliderComponent: Collision shape information
 */
